...
The current release candidate pins Flue runtime and SDK 1.0.0-beta.9 and Pi
AI 0.80.10. Run the clean npm installation test in CI so a host does not
silently lose the checked-in dependency patches. Stable 0.5.0 must use an
upstream stable Flue release.
