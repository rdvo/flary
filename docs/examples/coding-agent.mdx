---
title: Coding agent
description: Build a durable coding thread with lazy tools, workspace policy, and explicit modes.
section: Examples
order: 2
---
...
grant itself a stronger mode. See [Modes and permissions](/docs/modes-permissions/)
for the complete profile shape, custom modes, thread storage, and recovery
rules.
