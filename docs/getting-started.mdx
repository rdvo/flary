...
description: Install Flary, compile a prompt file, and add a durable thread when your product needs one.
section: Start
order: 1
---
...
Cloudflare resources. Follow the [support bot](/docs/examples/support-bot/) or
[coding agent](/docs/examples/coding-agent/) guide when you add durable threads.
...
Read [Cloudflare resources](/docs/cloudflare-resources/) before deployment.
