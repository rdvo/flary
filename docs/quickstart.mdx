...
The dashboard starter includes first-owner login, a thread console, provider
setup, MCP connections, and secret-health status. The backend is headless and
exposes the same durable agent runtime through typed APIs.
