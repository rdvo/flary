...
import * as handler_flary_thread_0 from "/Users/rob/dev/flary/apps/cloud/src/agents/flary-thread.ts";


import userApp from "/Users/rob/dev/flary/apps/cloud/src/app.ts";
import * as userCloudflareModule from "/Users/rob/dev/flary/apps/cloud/src/cloudflare.ts";
export * from "/Users/rob/dev/flary/apps/cloud/src/cloudflare.ts";
...
const agentModules = {
  "flary-thread": handler_flary_thread_0,
};
...
const agentIdentities = {
  "flary-thread": { bindingName: "FLUE_FLARY_THREAD_AGENT", className: "FlueFlaryThreadAgent" },
};
...
const reservedCloudflareExportNames = new Set(["FlueFlaryThreadAgent","FlueRegistry"]);
...
const agentExtension0 = resolveCloudflareExtension(agentModules["flary-thread"], "flary-thread", 'Agent');
const FlueFlaryThreadAgent = class FlueFlaryThreadAgent extends agentExtension0.base(Agent) {
  constructor(ctx, env) {
    const prepared = cloudflareAgents.prepare({ storage: ctx.storage, className: "FlueFlaryThreadAgent", agentName: "flary-thread" });
    super(ctx, env);
...
const WrappedFlueFlaryThreadAgent = agentExtension0.wrap(FlueFlaryThreadAgent);
export { WrappedFlueFlaryThreadAgent as FlueFlaryThreadAgent };
