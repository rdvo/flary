/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 5a7be44ec2569dd77218ff52edcd4127)
...
interface __BaseEnv_CloudflareEnv {
	...
	AI: Ai;
	ASSETS: Fetcher;
	APP_URL: "https://flary-cloud.cosmicmarketing.workers.dev" | "http://localhost:5173";
	APP_ENV: "production" | "development";
	EMAIL_DELIVERY_ENABLED: "false";
	EMAIL_FROM: "Flary <noreply@flary.dev>" | "Flary Local <noreply@example.com>";
	SANDBOX_TRANSPORT: "rpc";
	CODE_MODE_ENABLED: "false";
	ORG_COORDINATOR: DurableObjectNamespace<import("./worker/index").OrgCoordinator>;
	PROJECT_WORKSPACES: DurableObjectNamespace<import("./worker/index").WorkspaceFilesystem>;
	FLARY_SANDBOX: DurableObjectNamespace<import("./worker/index").FlarySandbox>;
	FLUE_FLARY_THREAD_AGENT: DurableObjectNamespace /* FlueFlaryThreadAgent */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "OrgCoordinator" | "WorkspaceFilesystem" | "FlarySandbox" | "FlueFlaryThreadAgent" | "FlueRegistry";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "APP_ENV" | "EMAIL_DELIVERY_ENABLED" | "EMAIL_FROM" | "SANDBOX_TRANSPORT" | "CODE_MODE_ENABLED">> {}
}
